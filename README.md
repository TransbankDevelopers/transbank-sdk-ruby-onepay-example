# Proyecto de ejemplo para uso de Onepay con el SDK de Transbank para Ruby
...
Editar el archivo `transbank-sdk-ruby-onepay-example/app/views/transaction/index.html.erb` y cambiar la versión de `merchant.onepay.min.js`
